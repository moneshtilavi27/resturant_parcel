                            ...
                            <form class="form-horizontal" id="addform" action="item_insert.php" method="POST">
                                <div class="box-body">
                                    <div class="form-group col-md-4">
                                        ...
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" name="itm" id="itm"
                                                placeholder="Item Name" v-model="itmnam">
                                        </div>
                                    </div>
                                    ...
                                    <input type="hidden" step="0.01" name="qty" id="inputPassword3"
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button v-on:click="editItem($event)" class="btn btn-primary btn-sm"
                                            data-toggle="modal" data-target="#myModal"><i
                                                class="fa fa-fw fa-edit"></i>Edit</button>
                                        <a href="item_edit.php?del=<?php echo $row['slno'];?>"
