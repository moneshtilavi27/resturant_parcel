                    ...
                    <div class="box box-default">
                        ...
                        <div class="row" >
                            <div class="col-md-12">
                                ...
                                <!-- /.box-header -->
                                <!-- form start -->
                               <form class="form-horizontal" role="form" action="insert_product.php" method="post">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            &nbsp;&nbsp;<input type="text" id="form-field-1" placeholder="Name of Product" name="t1" class="col-xs-10 col-sm-5" required="required" />
                                        </div>
                                </div>
