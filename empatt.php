...
<![endif]-->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Employee Attendence
        <small>Add Employee Attendence</small>
      </h1>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Employee Attendence</h3>
            </div>
            <!-- /.box-header -->
    ...
    $sql="select * from empreg ";
            ...
            while($row=mysqli_fetch_array($res))
           {
            ...
            echo "<tr id='tbletr'><form action='empatt1.php' method='POST'><input type='hidden' id='empno' name='empno' value='$empno'> <td>{$row['empname']}</td><td>{$row['address']}</td> <td>{$row['mobile']}</td><td>{$row['empid']}</td>
            <td><button class='btn btn-primary' type='submit'  id='{$row['empid']}'>Attendence</button></form></td></tr>\n";
